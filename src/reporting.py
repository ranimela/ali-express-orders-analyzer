    ...
    if not active_orders:
        ...
        for order in active_orders:
            ...
            html_lines.extend(
                [
                    "                    <tr>",
                    f'                        <td data-label="Status"><span class="badge {badge_class}">{badge_emoji} {order["latest_status"]}</span></td>',
                    f'                        <td data-label="Tracking ID" class="tbl-tracking">{tracking}</td>',
                    f'                        <td data-label="Order ID" class="tbl-order-id">{order["order_id"].replace("TRACKING_", "").replace("GENERIC_", "")}</td>',
                    '                        <td data-label="Items Grouped">',
            ...
            html_lines.extend(
                [
                    ...
                    "                            </table>",
                    "                        </td>",
                    f'                        <td data-label="Logistics Carrier" class="tbl-carrier">{carrier}</td>',
                    f'                        <td data-label="Latest Update">{event_html}</td>',
                    "                    </tr>",
                ]
            )
